...
abstract class ArchitectureValidateTask : DefaultTask() {
    ...
    fun validate() {
        ...
        val edges: Map<String, Set<String>> = mapOf(
            ...
            ":libs:design" to emptySet(),
            ":hooks:hooks-api" to emptySet(),
            ":hooks:libxposed-api" to emptySet(),
            ":hooks:hooks-common" to setOf(":libs:config", ":hooks:hooks-api"),
            ":hooks:control-center" to setOf(":hooks:hooks-common", ":hooks:hooks-api", ":libs:config", ":hooks:libxposed-api"),
            ":launcher:app" to setOf(":libs:design", ":launcher:control-center"),
            ":launcher:control-center" to setOf(":libs:design", ":libs:config"),
