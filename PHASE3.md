...
|---|---|---|
| 3.1 LSPosed Modern API Foundation | Module skeleton, modern API, targeting, flags, crash protection, rollback | Compiles + **disabled module = system unchanged** (device) |
