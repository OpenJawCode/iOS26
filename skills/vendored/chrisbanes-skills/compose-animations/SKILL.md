...
description: "Use when writing or reviewing Jetpack Compose motion: visibility enter/exit, animating properties, color/size transitions, multiple properties from one state, switching content, or choosing between AnimatedVisibility, animate*AsState, rememberTransition, AnimatedContent, Crossfade."
---
